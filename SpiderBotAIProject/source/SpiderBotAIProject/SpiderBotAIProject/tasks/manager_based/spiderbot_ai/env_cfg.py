...
class RewardsCfg:
    ...
    velocity_alignment = RewTerm(func=mdp.velocity_alignment_reward, weight=1.25e3)
    ...
    speed = RewTerm(func=mdp.speed_reward, weight=0.0e2)
    ...
    feet_air_time = RewTerm(func=mdp.feet_air_time_reward, weight=1.0e2)

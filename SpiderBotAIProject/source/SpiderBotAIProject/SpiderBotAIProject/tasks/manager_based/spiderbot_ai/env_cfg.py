...
class RewardsCfg:
    ...
    progress = RewTerm(func=mdp.progress_reward, weight=2.0e3)
    ...
    speed = RewTerm(func=mdp.speed_reward, weight=4.0e2)
    ...
    undesired_contacts = RewTerm(func=mdp.undesired_contacts_penalty, weight=-1.25e2)
    feet_contact_force = RewTerm(func=mdp.feet_contact_force_penalty, weight=-1.0e-7)
    flat_orientation = RewTerm(func=mdp.flat_orientation_l2, weight=-2.0e1)
    ...
    stillness = RewTerm(func=mdp.stillness_penalty, weight=-1.0e2)
